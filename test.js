...
auth.encrypt('sOmePazzWo2d', function(err, data){
  ...
  auth.authenticate({password: 'sOmePazzWo2d'}, {password: hash}, function(err, data){
    ...
    console.log('Token test--Note: Due to milliseconds difference between expiration time set and expiration time retrieval, this test could fail within a small fractional time frame each day');
